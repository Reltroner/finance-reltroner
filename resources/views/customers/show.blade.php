    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">Detailed view of the selected customer</p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div>
                    ...
                    <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-primary btn-sm">Edit Customer</a>
                </div>
            </div>
        </div>
    </section>
